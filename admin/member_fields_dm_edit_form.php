...
<form name="editfieldform" method="POST" action="../admin/member_fields_dm_edit.php">
...
<table class="primary">
  ...
  <tr>
    <td align="center" colspan="2" class="primary">
      ...
      <input type="button" onClick="self.location='../admin/member_fields_dm_list.php'" value="  <?php echo $loc->getText("adminCancel"); ?>  " class="button">
    </td>
  </tr>
