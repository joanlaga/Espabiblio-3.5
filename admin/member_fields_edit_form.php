...
//print_r($_REQUEST);
    ...
    $mfQ = new MfQuery();
    $mfQ->connect();
    $mf = $mfQ->get1("member_fields",$mbrid);
...
<input type="hidden" name="code" value="<?php echo H($postVars["mbrid"]);?>">
<input type="hidden" name="code" value="<?php echo H($postVars["code"]);?>">
<input type="hidden" name="code" value="<?php echo H($postVars["data"]);?>">
<table class="primary">
  <tr>
