 ...
 */
  ...
  require_once("../catalog/marc_select.php");
...
<meta name="description" content="Espabiblio Library Automation System">
  ...
  <?php
    foreach($marcBlocks as $blockKey => $block) {
      ...
      if (strcmp($selectedBlock,$blockKey) == 0) {
        ...
        <a href="../catalog/marc_select.php?" class="nav">          -&nbsp;</a>
        </td>
        ...
        if ($marcTags != false) {
          foreach($marcTags as $tagKey => $tag) {
            ...
            if (strcmp($selectedTag,$tagKey) == 0) {
              ...
              <a href="../catalog/marc_select.php?" class="nav">
              -&nbsp;</a>
              ...
              if ($marcSubflds != false) {
                foreach($marcSubflds as $subfldKey => $subfld) {
                  ...
                  <td class="noborder">
                  <a href="javascript:backToMain('<?php echo H(addslashes("tag=".U($selectedTag)."&subfld=".U($subfld->getSubfieldCd())."&descr=".U($subfld->getDescription()))) ?>')" class="nav">
