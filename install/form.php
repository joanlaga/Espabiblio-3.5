...
<?php
  ...
  $mysql_date = implode(mysqli_fetch_row($installQ->_link->query('select sysdate();')));
      ...
      <blockquote>
        <form name="installForm" method="POST" action="../install/install.php">
          ...
          <table cellpadding=0 cellspacing=0 border=0>
            ...
            <tr>
              <td rowspan="1" valign="top" valign="left"><font class="primary"><?php echo $loc->getText("form_Test_data");?> : </font></td>
              <td><input type="checkbox" name="installTestData" value="yes"></td>
            </tr>
            <tr>
              <td rowspan="1" valign="top" valign="left"><font class="primary"><?php echo $loc->getText("form_CDU");//jalg para uso discrimitavo catalogo en base de datos?>: </font></td>
              <td><input type="checkbox" name="CDU" value="yes"></td>
            </tr>
            <tr>
              <td rowspan="1" valign="top" valign="left"><font class="primary"><?php echo $loc->getText("form_CDD");//jalg para uso discrimitavo catalogo en base de datos?>: </font></td>
              <td><input type="checkbox" name="CDD" value="yes"></td>
            </tr>
            <tr>
              <td rowspan="1" valign="top" valign="left"><font class="primary"><?php echo $loc->getText("form_IBIC");//jalg para uso discrimitavo catalogo en base de datos?>: </font></td>
              <td><input type="checkbox" name="IBIC" value="yes"></td>
            </tr>
            <tr>
              <td rowspan="1" valign="top" valign="left"><font class="primary"><?php echo $loc->getText("form_CUTTER");//jalg para uso discrimitavo catalogo en base de datos?>: </font></td>
