...
<table id="showList" name="showList" class="primary striped">
  ...
  <tr>
    ...
    <th valign="top" nowrap="yes">
      <?php echo $loc->getText("lookup_hostsContext"); ?>
    </th>
    <th valign="top" nowrap="yes">
      <?php echo $loc->getText("lookup_hostsSchema"); ?>
    </th>
    <th valign="top" nowrap="yes">
...
<table id='editTbl' class="primary">
  ...
  <tr>
    <td nowrap="true" class="primary">
      <label for="db" class="reqd"><sup>*</sup><?php echo $loc->getText("lookup_hostsContext"); ?>
    </td>
    <td valign="top" class="primary">
      <?php printInputText("context",16,16,$postVars,$pageErrors); ?>
    </td>
  </tr>
  <tr>
    <td nowrap="true" class="primary">
      <label for="db" class="reqd"><sup>*</sup><?php echo $loc->getText("lookup_hostsSchema"); ?>
    </td>
    <td valign="top" class="primary">
      <?php printInputText("schema",16,16,$postVars,$pageErrors); ?>
    </td>
  </tr>
  <tr>
    <td nowrap="true" class="primary">
